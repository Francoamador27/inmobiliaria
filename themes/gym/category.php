...
<?php $category_name = single_cat_title('', false);
 ?>
    <?php
...
if($property === 'venta'){
$property_name ='Inmuebles en venta ';
}
if($property ==='lotes'){
    $property_name = 'Terrenos en venta ';
}if($property === 'temporal'){
    $property_name = 'Alquiler temporario  ';
}
if($property === 'alquiler-anual'){
    $property_name = 'Alquiler anual ';
}
?>
...
<section class="banner-horizontal banner-search">
        ...
        <h3 class="title_banner"> Propiedades en  <?php echo $category_name ?> </h3>
        </div>
