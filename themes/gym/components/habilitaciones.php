...
<div class="mi-componente">
    <h3 class="hab-title3"> <?php the_title() ?></h3>
    <h4 class="habi-serv">Te asesoramos y logramos  todos los requisitos para conseguir lo mejor para tu empresa</h4>

    <?php
    $servicio = get_the_title();
