<h2 class="serv">Propiedades Destacadas en<span class="sec-color"> Venta</span> </h3>
        <section class="-quienes-somos">
            <div class="swiper mySwiper">
                <div class="swiper-wrapper">
                    <?php
                    $args = array(
                        'post_type' => 'venta', // Reemplaza 'tu_tipo_de_post' con el tipo de post que estás utilizando para tus tarjetas
                            ...
                            <div class="swiper-slide service">
                                ...
                                <div class="imagen">
                                    ...
                                    <div class="info">
                                        ...
                                        <p class="text-center desc-card"><?php echo get_field('descripcion_corta') ;?></p>
