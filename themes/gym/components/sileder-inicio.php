...
<div class="mi-componente">
    <h3 class="hab-title3"> ASESORAMIENTOS</h3>
    <h4 class="habi-serv">informacion adicional</h4>
...
<div class="contact-habi">
    ...
    <h3 class="eslogan-habilitacion">Tu Habilitación Segura y Exitosa. ¡Somos la Elección Indiscutible !</h3>
</div>    
