...
<li>                    <h3 class="wdg-title"> <?php the_title(); ?>    </h3>

<div class="imagen imagen-wdg">
...
<a href="<?php the_permalink(); ?>">
                ...
                <div>
                    <p class="wdg-d"><?php the_field('dias_clase');?></p>
                    <p class="wdg-hi"> <?php the_field('hora_inicio');?> </p>
                <p class="wdg-hf"> <?php the_field('hora_fin');?>
</p>
